...
{
    class JobManagerServiceAnalyser
    {
        ...
        public JobManagerServiceAnalyser(byte[] prm_byteaIncommingMessage)
        {
        ...
        public int iAnalyseIncommingMessageAndPrepareResponse(byte[] prm_baIncommingMessage, int prm_iIncommingMessageLength, out byte[] prm_baOutgoingMessage, out int prm_iOutgoingMessageLength, ref byte[] prm_baPacketCollectorBuffer, ref int prm_iPacketCollectorBufferLength)
        {
